...
const DoctorDashBoardPage = () => {
  ...
  const hhNumber = "888888"; // Hardcoded as requested
  ...
  const grantAccess = async () => {
    alert("Fetching the file...");
    setTimeout(() => {
      window.location.href = "http://localhost:3000/patient/888888/viewrecords";
    }, 0); // 5 seconds delay
  };
    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-black to-gray-800 p-4 sm:p-10 font-mono text-white h-screen flex flex-col justify-center items-center">
        ...
        <div className="space-y-4 space-x-4">
          ...
          <button
            onClick={grantAccess}
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg focus:outline-none focus:ring focus:ring-blue-400 transition duration-300"
          >
            Grant Access
          </button>
        </div>
